...
builder.Services.AddScoped<IUser, UserServiceFactory>();
builder.Services.AddScoped<IUserProfile, UserProfileServiceFactory>();
builder.Services.AddScoped<IJwtPasswordService, JwtPasswordService>();
...
{
    o.UseSqlServer(builder.Configuration.GetConnectionString("UserManagementServer"));
});
